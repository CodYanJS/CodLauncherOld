...
// TODO change
const dataPath = path.join(sysRoot, '.codcraft')
...
exports.getDataDirectory = function(def = false){
    return !def ? DEFAULT_CONFIG.settings.launcher.dataDirectory : config.settings.launcher.dataDirectory
}
...
exports.setDataDirectory = function(dataDirectory){
    DEFAULT_CONFIG.settings.launcher.dataDirectory = dataDirectory
}
